...
var RotasClass = {
    ...
    buscarRotas: function (celula, rota) {
        ...
        if (this.isCelulaFinal(vizinhos, rota) || this.isDestino(celula)) {
            ...
            var vizinhosValidos = this.buscarVizinhosValidos(celula, vizinhos, rota);
        }

        if (vizinhosValidos) {
            var alternativas = this.buscaAlternativas(celula);
            ...
            if (alternativas.length > 0) {
                ...
                vizinhosValidos.forEach(function (vizinho, index) {
                    RotasClass.alternativas.push({celula: celula, proxCelula: vizinho, percorrida: false});
                });
    ...
    buscarVizinhosValidos: function (celula, vizinhos, rota) {
        var vizinhosValidos = [];
    ...
    buscaAlternativas: function (celula) {
        var alternativas = [];
